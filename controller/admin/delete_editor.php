<?php
/* Name: Iran Vision / Delete Editors
   Author: Farhood Rashidi
	Date: 01/06/2015
   This script gets the editors's first name and last name ,and then deletes editor. 
*/
...
$newDatabae->select();
$newDatabae->delete_editor($lname, $fname);
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Iran Vision :: Delete Editors</title>
	...
	<body>
		...
		<aside>
			<!-- conetent start hear -->
			<h2>Delete Editors</h2>
			<article>
				<p style="text-align:center">Please enter the below information for delete the editors.</p>
				
				<!-- Begin Form -->
				<form name="deleteForm" id="deleteForm" method="post" action="delete_editor.php" >
					<p>
                    ...
                    <p>
                    	...
                    	<a href='../../view/editors.php'><input type='button' name='member' class='button' value='Deleted Editors >>' ></a>
                    </p>
                    <?=$message; ?>
